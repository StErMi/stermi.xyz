      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            <MobileNavLink href="https://stermi.xyz/feed.xml">
              Feed RSS
            </MobileNavLink>
          </Popover.Panel>
        </Transition.Child>
      ...
      <nav className="relative z-50 flex justify-between">
        ...
        <div className="flex items-center gap-x-5 md:gap-x-8">
          ...
          >
            <svg
              aria-hidden="true"
              className="h-6 w-6 cursor-pointer fill-slate-500 group-hover:fill-slate-700"
            >
          ...
          <Link
            ...
            aria-label="Feed RSS"
          >
            <RssIcon className="h-6 w-6 cursor-pointer fill-slate-500 group-hover:fill-slate-700" />
          </Link>
